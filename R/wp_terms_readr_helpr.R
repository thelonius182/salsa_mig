...
wpt <- read_csv(file = "/mnt/muw/wp_terms_export.csv")
...
wptr <- read_csv(file = "/mnt/muw/wp_post_term_relations.csv")
...
pgm_trms <- read_csv(file = "/mnt/muw/programs-terms.csv")
...
in_scope_program_terms <- read_csv("/mnt/muw/in_scope_program_terms.csv")
